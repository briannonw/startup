  ...
  return (
    <main className="main-text">
      ...
      <div className="top-pic">
          <img className="main-img" src="https://c8.alamy.com/comp/2HNPHJE/four-seasons-concept-with-spring-blossom-summer-beach-autumn-leaves-and-snow-2HNPHJE.jpg" alt="Pic for Quiz 1" />
      </div>
